    ...
    <div id="user_area">
        ...
        <div id="user_nav">
            <div class="user_info">
                ...
                <a class="btn" style="width: 98%;background-color: yellow;color:yellow);" href="<%=basePath%>user/myPurse">我的钱包：￥${myPurse.balance}</a>
                <input type="hidden" value="${myPurse.recharge}" id="recharge"/>
                <input type="hidden" value="${myPurse.withdrawals}" id="withdrawals"/>
                <span class="btn" data-toggle="modal" data-target="#myModal" style="width: 98%;background-color: yellow; color:yellow);margin-top:0.5cm;">
